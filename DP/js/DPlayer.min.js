!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        (function(t) {
            ...
            var s, l = {
                adapter: (void 0 !== t && "[object process]" === Object.prototype.toString.call(t) ? s = n(9) : "undefined" != typeof XMLHttpRequest && (s = n(9)),
                s),
    ...
    , function(e, t, n) {
        ...
        e.exports = function(e) {
            return new Promise(function(t, c) {
                ...
                ,
                p.onabort = function() {
                    p && (c(l("Request aborted", e, "ECONNABORTED", p)),
                    p = null)
                }
                ,
                p.onerror = function() {
    ...
    , function(e, t, n) {
        ...
        var G = function() {
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    this._readAllEndpoints(n, function(e) {
                ...
                value: function(e) {
                    ...
                    if (this.showing) {
                          ...
                          , c = function(e, n, a) {
                            for (var o = i / l(a), c = function(a) {
                                ...
                                for (var u = 0; u < c.length; u++) {
                                    var d = s(c[u]) - 10;
                                    if (d <= i - o * l(parseInt(c[u].style.width)) || d <= 0)
                                        break;
                                    if (u === c.length - 1)
                        ...
                        for (var u = document.createDocumentFragment(), d = function(a) {
                            ...
                            switch (e[a].type) {
                            case "right":
                                (l = c(r, e[a].type, s)) >= 0 && (r.style.width = s + 1 + "px",
                                r.style.top = n * l + "px",
                ...
                value: function() {
                    for (var e = this.container.offsetWidth, t = this.container.getElementsByClassName("dplayer-danmaku-item"), n = 0; n < t.length; n++)
                        t[n].style.transform = "translateX(-".concat(e, "px)")
                }
            }, {
                key: "hide",
                value: function() {
        ...
        var ne = function() {
            function e(t) {
                ...
                var i = function() {
                    n.player.resize(),
                    n.isFullScreen("browser") ? n.player.events.trigger("fullscreen") : (o.setScrollPosition(n.lastScrollPosition),
                  ...
                  , a = function() {
                    ...
                    e ? n.player.events.trigger("fullscreen") : (o.setScrollPosition(n.lastScrollPosition),
                    n.player.events.trigger("fullscreen_cancel")))
                };
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    switch (n || (this.lastScrollPosition = o.getScrollPosition()),
                    e) {
                    case "browser":
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    this.player.template.volumeButtonIcon.addEventListener("click", function() {
                        ...
                        e.player.template.volumeIcon.innerHTML = U.volumeOff,
          ...
          , _e = function() {
            ...
            (n = [{
                ...
                value: function() {
                    var e = this;
                    if (this.paused = !1,
                    this.video.paused && this.bezel.switch(U.play),
                    this.template.playButton.innerHTML = U.pause,
                    i.a.resolve(this.video.play()).catch(function() {
                        e.pause()
                    }).then(function() {}),
                ...
                value: function() {
                    ...
                    this.video.paused || this.bezel.switch(U.pause),
                ...
                value: function(e, t) {
                    ...
                    this.options.subtitle && (this.subtitle = new re(this.template.subtitle,this.video,this.options.subtitle,this.events),
        ...
        ;console.log("\n %c 视觉影院 %c http://www.shijueyy.com \n", "color: #fff; background: #727cf5; padding:5px 0;", "background: #ddd; color: #fff; padding:5px 0;");
        t.default = _e
    }
    ]).default
});